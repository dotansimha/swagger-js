...
Operation.prototype.prettyPrint = function(obj) {
  ...
  console.log("[SwaggerClient] ", getActualObjectWithEncryption(body, true));
};
...
Operation.prototype.execute = function (arg1, arg2, arg3, arg4, parent) {
  ...
  if (opts.mock === true) {
    ...
    return new SwaggerHttp().execute(getActualObjectWithEncryption(obj, false), opts);
  }
};
